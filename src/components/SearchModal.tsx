          ...
          {minHeight && maxHeight > 0 && (
            <div className="m-4 gnomle-height-selector">
              <label className="mb-3">
                Height{" "}
                {"(" +
                  math.round(selectedHeightRange.min, 1) +
                  " - " +
                  math.round(selectedHeightRange.max, 1) +
                  ")"}
              </label>
              <InputRange
          ...
          {minWeight && maxWeight > 0 && (
            <div className="m-4 gnomle-weight-selector">
              <label className="mb-3">
                Weight{" "}
                {"(" +
                  math.round(selectedWeightRange.min, 1) +
                  " - " +
                  math.round(selectedWeightRange.max, 1) +
                  ")"}
              </label>
              <InputRange
