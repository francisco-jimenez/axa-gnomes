...
context("Gnomle tests", () => {
  ...
  it("First card is Tobus Quickwhistle and cheking all its data is being displayed correctly", () => {
    cy.get(".ui.raised.card")
      .first()
      .should("contain.text", "Tobus Quickwhistle");
    ...
    cy.get(".ui.raised.card")
      .first()
      .should("not.contain.text", "Cogwitz Chillwidget");
  });
  ...
  it("Click on Tobus Quickwhistle friends and check they are displayed and hide them again", () => {
    ...
    cy.get(".ui.raised.card")
      .first()
      .should("contain.text", "Cogwitz Chillwidget");
  ...
  it("Search for fi, first results should be Fizkin Voidbuster, Fizkin Switchbuster, Fizwood Clankstorque, Fizwood Wrongslicer", () => {
    ...
    cy.get(".ui.raised.card")
      .first()
      .should("contain.text", "Fizkin Voidbuster");
    cy.get(".ui.raised.card")
      .eq(1)
      .should("contain.text", "Fizkin Switchbuster");
    cy.get(".ui.raised.card")
      .eq(2)
      .should("contain.text", "Fizwood Clankstorque");
    cy.get(".ui.raised.card")
      .eq(3)
      .should("contain.text", "Fizwood Wrongslicer");
  });
